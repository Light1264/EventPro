...
class LocalCacheImpl implements LocalCache {
  ...
  @override
  Map<String, dynamic>? getMarketPlaceData() {
    try {
      final data = getFromLocalCache(_marketPlaceData) as String?;
      if (data == null) return null;
      return jsonDecode(data) as Map<String, dynamic>;
    } catch (e) {
      return null;
  ...
  @override
  Future<void> saveMarketPlaceData(Map<String, dynamic> json) async {
    await saveToLocalCache(
      key: _marketPlaceData,
      value: json,
    );
  }
}
